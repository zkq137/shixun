...
.ai-result :deep(h1) { font-size: 18px; border-bottom: 2px solid #e2e8f0; padding-bottom: 6px; }
.ai-result :deep(h2) { font-size: 16px; }
.ai-result :deep(h3) { font-size: 14px; }
...
.ai-result :deep(tr:nth-child(even) td) {
  background: #f8fafc;
}
